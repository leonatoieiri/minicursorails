...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { ano_id: @aluno.ano_id, data_de_nascimento: @aluno.data_de_nascimento, nome: @aluno.nome, turma_id: @aluno.turma_id } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { ano_id: @aluno.ano_id, data_de_nascimento: @aluno.data_de_nascimento, nome: @aluno.nome, turma_id: @aluno.turma_id } }
